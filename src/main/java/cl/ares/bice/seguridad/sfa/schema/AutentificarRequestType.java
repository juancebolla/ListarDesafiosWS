...
@XmlType(name = "AutentificarRequestType", namespace = "http://www.bice.cl/bice-ws/seguridad/desafio/schemas", propOrder = {
    "usuarioId",
    "grupo",
    "ipCliente",
    "tipoDesafio",
...
public class AutentificarRequestType {
    ...
    @XmlElement(name = "RespuestaDesafio", namespace = "http://www.bice.cl/bice-ws/seguridad/desafio/schemas", required = true)
