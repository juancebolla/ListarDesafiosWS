 ...
 *       &lt;sequence>
 *         &lt;element name="Desafio" type="{http://www.bice.cl/bice-ws/seguridad/desafio/schemas}DesafioType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "DesafiosType", namespace = "http://www.bice.cl/bice-ws/seguridad/desafio/schemas", propOrder = {
    "desafio"
})
public class DesafiosType {

    @XmlElement(name = "Desafio", namespace = "http://www.bice.cl/bice-ws/seguridad/desafio/schemas", required = true)
